...
export default function MobileNavbarWrapper({
  ...
  return (
    <motion.div
      ...
      className={`fixed bottom-0 left-0 right-0 z-50 flex h-[4rem] flex-col items-center justify-center gap-y-5 border border-t border-gray-200 bg-white shadow-md shadow-black/30 transition-all duration-200 ease-in-out sm:hidden`}
      role="navigation"
    >
      {children}
    </motion.div>
