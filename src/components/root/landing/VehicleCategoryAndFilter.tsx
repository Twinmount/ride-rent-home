...
export default function VehicleCategoryAndFilter() {
  ...
  return (
    <div
      className={`bg-bgGray sticky z-30 my-3 flex items-center justify-between ${isHidden && "shadow"}`}
      style={{
    ...
    >
      <div
        className={`mx-auto flex w-[95%] items-center justify-between gap-x-4 p-0 pt-4 md:pl-8 lg:gap-x-10`}
      >
