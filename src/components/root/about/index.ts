export const aboutGridData = [
  {
    icon: '/assets/icons/about/affordable.svg',
    title: 'Most Affordable Listing Cost',
    subtitle: 'List your vehicle at competitive prices.',
  },
  {
    icon: '/assets/icons/about/quicker-returns.svg',
    title: 'Quicker Return on Investment',
    subtitle:
      'Instant bookings and high-quality leads guarantee faster returns',
  },
  {
    icon: '/assets/icons/about/zero-commission.svg',
    title: 'Zero Commission',
    subtitle:
      "We don't take any commission ensuring maximum earnings for owners",
  },
  {
    icon: '/assets/icons/about/coverage.svg',
    title: 'Wide UAE Coverage',
    subtitle: 'Reach a vast audience across multiple cities in the UAE',
  },
]
