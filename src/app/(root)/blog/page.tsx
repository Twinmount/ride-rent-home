...
import { CategoryType, ParamsProps } from "@/types/blog";

export default function HomePage({ searchParams }: ParamsProps) {
  const selectedTag = searchParams.tag || "all";
  const page = parseInt(searchParams.page || "1", 10);

  return (
    <section className="wrapper py-8">
      <h1 className="text-2xl font-semibold lg:text-4xl">Ride.Rent/Advisor</h1>
