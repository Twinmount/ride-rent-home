...
export default function CardPriceOfferTimer({
  ...
  const className =
    layoutType === "carousel"
      ? "h-[1.8rem] w-[5rem] lg:h-[2.18rem] lg:w-[5.5rem] text-[0.6rem] lg:text-xs px-8"
