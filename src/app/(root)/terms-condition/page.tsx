...
export async function generateMetadata() {
  ...
  const description = `Review the terms and conditions for using RideRent Automobile Aggregators L.L.C services, including policies for users, agents, and advertisers.`
