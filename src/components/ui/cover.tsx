...
export const Cover = ({
  ...
  return (
    <div
      ...
      ref={ref}
      className={`group/cover flex-center relative inline-block w-full overflow-hidden rounded-[0.5rem] bg-[#2c2c2c] px-2 py-2 transition`}
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
          ...
          >
            ...
            >
              <SparklesCore
                ...
                minSize={0.4}
                maxSize={1}
                particleDensity={1000} // double density on hover
      ...
      <motion.span
        ...
        animate={{
          scale: hovered ? 0.8 : 1,
          x: hovered ? [0, -15, 15, -15, 15, 0] : 0,
          y: hovered ? [0, 15, -15, 15, -15, 0] : 0,
        }}
        exit={{
          filter: "none",
          scale: 1,
        ...
        className={cn(
          "relative z-20 inline-block text-neutral-900 transition duration-200",
          className,
        )}
      >
        {children}
