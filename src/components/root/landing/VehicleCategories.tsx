      ...
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger
            ...
            className={`flex-center line-clamp-1 h-12 max-w-[7rem] gap-2 rounded border px-3 py-1 text-sm font-semibold text-text-primary hover:text-text-primary lg:max-w-[9rem] ${isCategoriesLoading ? 'cursor-default text-gray-500' : 'bg-theme-gradient hover:bg-theme-gradient'}`}
          >
            <Image
