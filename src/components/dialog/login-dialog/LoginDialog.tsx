        ...
        <Tabs defaultValue="login" className="w-full">
          ...
          <TabsContent value="login" className="mt-6 space-y-4">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Select defaultValue="+971">
                    <SelectTrigger className="w-24 focus-visible:ring-0 focus-visible:ring-offset-0 focus:ring-0 focus:ring-offset-0">
                      <SelectValue />
                    </SelectTrigger>
              ...
              <Button className="bg-orange-500 hover:bg-orange-600 w-full text-white">
                Login
              </Button>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="lastName" placeholder="Last name" className="focus-visible:ring-0 focus-visible:ring-offset-0" />
                </div>
              </div>
