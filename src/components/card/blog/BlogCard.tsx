...
export default function BlogCard({ blog, country }: BlogCardProps) {
  ...
  return (
    <MotionDiv className="group mx-auto h-full w-full min-w-[265px] max-w-sm transform overflow-hidden rounded-xl bg-white shadow-lg transition duration-300 hover:scale-[1.02] hover:shadow-xl">
